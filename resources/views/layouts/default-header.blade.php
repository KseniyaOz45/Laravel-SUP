<nav class="navbar navbar-expand-md bg-body py-3">
    <div class="container"><a class="navbar-brand d-flex align-items-center" href="#"><span class="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center me-2 bs-icon"><i class="fa fa-user"></i></span><span style="font-size: 25px;font-family: 'BIZ UDPGothic', sans-serif;font-weight: bold;">SUP</span></a>
        <div class="d-lg-flex align-items-lg-center" id="short_data_container" style="width: auto;margin: 0px;"><span class="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center me-2 bs-icon" style="width: auto;padding: 6px 12px;gap: 5px;height: 37.333px;max-width: 100px;"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-list-task">
                    ...
                    </svg><span style="font-family: 'Arsenal SC', sans-serif;font-weight: bold;">{{ $tasks_count }}</span></span><span class="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center me-2 bs-icon" style="width: auto;padding: 6px 12px;gap: 5px;height: 37.333px;max-width: 100px;"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none">
        ...
        <div class="collapse navbar-collapse" id="navcol-1">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="{{ route('clientsMenu') }}" style="font-family: 'Arsenal SC', sans-serif;">Clients catalog</a></li>
            </ul>
