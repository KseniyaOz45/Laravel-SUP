            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="d-lg-flex justify-content-between align-items-lg-center">
                        <h1 style="font-family: 'BIZ UDPGothic', sans-serif;font-weight: bold;">Orders</h1>
                                ...
                                @foreach($user_orders as $order)
                                    <tr>
                                        ...
                                        <td class="text-truncate text-break d-lg-flex justify-content-lg-center table_actions_container">
                                            <a href="{{ route('orders.edit', $order) }}" class="btn btn-primary d-lg-flex justify-content-lg-center align-items-lg-center" role="button">
                                            ...
                                            <form action="{{ route('orders.destroy', $order) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-primary d-lg-flex justify-content-lg-center align-items-lg-center" role="button">
